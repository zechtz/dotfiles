function personal-vpn --description 'Manage Personal VPN connection (start, stop, status)'
    set vpn_config "/opt/homebrew/etc/openvpn/personal.ovpn"
    set pid_file "/tmp/personal-vpn.pid"
    ...
    switch $argv[1]
        ...
        case '*'
            echo "Usage: personal-vpn [start|stop|status]"
            return 1
    end
end
