function mnrt-vpn --description 'Manage MNRT VPN connection (start, stop, status)'
    set vpn_config "/Volumes/Work/work/ovpn/configs/mnrt_portal.ovpn"
    set pid_file "/tmp/mnrt-vpn.pid"
    ...
    switch $argv[1]
        ...
        case '*'
            echo "Usage: mnrt-vpn [start|stop|status]"
            return 1
    end
end
