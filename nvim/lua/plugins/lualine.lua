return {
  ...
  opts = function()
    ...
    -- Icons (fallback if nvim-web-devicons is not available)
    local icons = {
      diagnostics = {
        Error = "",
        Warning = "",
    ...
    if has_devicons then
      local telescope_icon = devicons.get_icon("telescope", "telescope")
      if telescope_icon then
        icons.ui.Telescope = telescope_icon
      end
    end
    ...
    local language_server = {
      function()
        ...
        -- Format language servers display
