...
local filetype = {
  ...
  fmt = function(str)
    local ui_filetypes = {
      "help", "packer", "neogitstatus", "NvimTree", "Trouble", "lir", "Outline", "spectre_panel",
      "toggleterm", "DressingSelect", "", "nil"
    }
    ...
    if str == "TelescopePrompt" then return return_val(icons.ui.Telescope) end
...
local current_signature = {
  function()
    ...
    if buf_ft == "toggleterm" or buf_ft == "TelescopePrompt" then return "" end
...
local spaces = {
  function()
    ...
    return hl_str(" ", "SLSep") .. hl_str(" " .. shiftwidth .. space, "SLIndent")
               .. hl_str("", "SLSep")
  end,
  padding = 0
  -- separator = "%#SLSeparator#" .. " │" .. "%*",
...
local lanuage_server = {
  function()
    ...
    local ui_filetypes = {
      "help", "packer", "neogitstatus", "NvimTree", "Trouble", "lir", "Outline", "spectre_panel",
      "toggleterm", "DressingSelect", "TelescopePrompt", "lspinfo", "lsp-installer", ""
    }
    ...
    if client_names_str_len ~= 0 then
      language_servers = hl_str("", "SLSep") .. hl_str(client_names_str, "SLSeparator")
                             .. hl_str("", "SLSep")
    end
...
lualine.setup {
  ...
  sections = {
    ...
    lualine_b = {left_pad_alt, diff, right_pad_alt},
    -- lualine_c = {},
