...
vim.g.tabline_hidden = true -- start with tabline hidden; toggle with <leader>ot
opt.showtabline = 0
opt.switchbuf = "useopen,uselast" -- reuse existing windows/buffers, never auto-create tabs
