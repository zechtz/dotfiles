vim.cmd([[
  ...
  augroup _lsp
    autocmd!
    autocmd BufWritePre *.elm,*.prisma,*.heex,*.proto,*.go,*.rs,*.ex,*.erl,*.exs,*.rb,*.ts,*.tsx,*.jsx,*.js,*.lua,*.vue,*.css,*.scss,*.sass,*.html,*.py,*.elixir,*.java lua vim.lsp.buf.format { async = true }
  augroup end
